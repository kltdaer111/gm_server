	...
	do{
        ...
        else
        {
            $conn->set_charset("utf8");
                ...
                $sql = "update platform_info set  platform_name='$data->platform_name', channel_name='$data->channel_name', version='$data->version', compatible_version='$data->compatible_version' where mark_type = '$data->mark_type'";
